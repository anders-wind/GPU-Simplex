...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Matrix representation of a linear program with 3 variables and 2 constraints. The red cells correspond to the constraint matrix,  the blue cells correspond to the c vector, and the green cells correspond to the constants vector.}
\end{table}