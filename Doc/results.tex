...
\todo{introduce graphs, explain seq and par not directly comparable. mention something about choice for data size (limited by size of memory and time taken to generate), mention that graphs are not comparable because they use different scales.}
